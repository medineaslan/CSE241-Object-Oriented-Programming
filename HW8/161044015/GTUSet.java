/**
 * GTUSet class with some methods
 * @author Medine ASLAN
...
public class GTUSet<T> extends GTUContainer<T> {
    ...
    /**
     * This method inserts item to collection. If collection has this item it will not inserted
    ...
    public boolean insert(T item) {
        ...
        throw new IllegalArgumentException("Set has already have this item : " + item);
    }
     ...
     * @param <T> Generic type of objects
     */
    private class GTUSetIterator<T> implements GTUIterator<T>
    {
        /**
